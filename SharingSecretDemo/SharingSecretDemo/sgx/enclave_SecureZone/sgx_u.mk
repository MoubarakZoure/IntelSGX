...
$(UNTRUSTED_DIR)/SecureZone_u.c: $(SGX_EDGER8R) trusted/SecureZone.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../trusted/SecureZone.edl --search-path ../trusted --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"

$(UNTRUSTED_DIR)/SecureZone_u.o: $(UNTRUSTED_DIR)/SecureZone_u.c
	@$(CC) $(App_C_Flags) -c $< -o $@
	@echo "CC   <=  $<"
...
sample: $(UNTRUSTED_DIR)/SecureZone_u.o $(App_Cpp_Objects)
...
clean:
	@rm -f sample  $(App_Cpp_Objects) $(UNTRUSTED_DIR)/SecureZone_u.* 
